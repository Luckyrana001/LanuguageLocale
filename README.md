# LanuguageLocale
English to Arabic and Arabic to English Locale change example for android
In this Sample App, i am changing Locale from English to Arabic / Arabic to English.

You can add any number of different Locales as per your requirements.



LocaleGif.gif

Countries Locale code and names as per Android 24 api.
